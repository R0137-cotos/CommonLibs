...
public class ContractDetailForFindAllDetailsBplatsDto extends EntityBase {
	 ...
	 * 変更前数量
	 */
	@Schema(description = "変更前数量", required = false, allowableValues = "range[0,99999]")
	 ...
	 * イニシャル売上計上処理状態
	 */
	@Schema(description = "イニシャル売上計上処理状態", required = false, allowableValues = "未処理(\"0\"), CSV作成済み(\"1\"), 連携済み(\"2\"), 対象外(\"3\")")
	 ...
	 * FFM内部振替処理状態
	 */
	@Schema(description = "FFM内部振替処理状態", required = false, allowableValues = "未処理中(\"0\"), 作成完了(\"1\"), 連携済み(\"2\"), 対象外(\"3\")")
	 ...
	 * FFM検収連携状態
	 */
	@Schema(description = "FFM検収連携状態", required = false, allowableValues = "未作成(\"0\"), 作成済み(\"1\"), 作成エラー(\"2\"), 対象外(\"3\")")

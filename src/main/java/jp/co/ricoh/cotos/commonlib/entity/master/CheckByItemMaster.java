...
public class CheckByItemMaster extends EntityBaseMaster {
	...
	@Schema(description = "品種別チェック項目マスタID", required = true, allowableValues = "range[0,9999999999999999999]")
	private long id;
	 ...
	 */
	@Max(9)
	@Schema(description = "受付担当必須フラグ", required = false, allowableValues = "range[0,9]")
	 ...
	 */
	@Max(9)
	@Schema(description = "導入担当必須フラグ", required = false, allowableValues = "range[0,9]")
	 ...
	 */
	@Max(9)
	@Schema(description = "保守担当必須フラグ", required = false, allowableValues = "range[0,9]")
	 ...
	 */
	@Max(9)
	@Schema(description = "設置先必須フラグ", required = false, allowableValues = "range[0,9]")
	 ...
	 */
	@Max(9)
	@Schema(description = "得意先必須フラグ", required = false, allowableValues = "range[0,9]")

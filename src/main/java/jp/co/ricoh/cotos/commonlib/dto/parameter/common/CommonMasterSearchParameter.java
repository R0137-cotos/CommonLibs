...
public class CommonMasterSearchParameter {
	 ...
	 * サービスカテゴリ
	 */
	@Parameter(description = "サービスカテゴリ", required = false, allowableValues = "共通(\"0\"), 見積(\"1\"), 契約(\"2\"), 手配(\"3\")")
	 ...
	 * カラム名
	 */
	@Parameter(description = "カラム名", required = false, allowableValues = "range[0,255]")

...
public class OrderDistributorInfoDto {
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "販売店区分", required = false, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "販売店担当営業", required = false, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "販売店担当営業メールアドレス", required = false, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "販売店郵便番号", required = false, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "販売店住所", required = false, allowableValues = "range[0,255]")

...
public class BillingCustomerInfo {
	...
	@Schema(description = "振込先自社口座_銀行コード(1)", allowableValues = "range[0,1326")
	private String bnkCd1;

	@Schema(description = "振込先自社口座_本支店コード(1)", allowableValues = "range[0,1326")
	private String bnkBranchCd1;

	@Schema(description = "振込先自社口座_口座番号(1)", allowableValues = "range[0,1326")
	private String bnkAccountCd1;

	@Schema(description = "振込先自社口座_銀行コード(2)", allowableValues = "range[0,1326")
	private String bnkCd2;

	@Schema(description = "振込先自社口座_支店コード(2)", allowableValues = "range[0,1326")
	private String bnkBranchCd2;

	@Schema(description = "振込先自社口座_口座番号(2)", allowableValues = "range[0,1326")
	private String bnkAccountCd2;

	@Schema(description = "振込先自社口座_口座種別(1)", allowableValues = "range[0,1326")
	private String bankAccountCls1;

	@Schema(description = "振込先自社口座_口座種別(2)", allowableValues = "range[0,1326")

...
public class TmCreateCustomerRequestWork extends AbstractTmRequestWork {
	...
	@Schema(description = "トレンドマイクロ顧客情報作成リクエストWORK ID", required = true, allowableValues = "range[0,9223372036854775807]", readOnly = true)
	private long id;
	...
	@Schema(description = "トレンドマイクロ顧客情報作成レスポンスWORK", required = false)

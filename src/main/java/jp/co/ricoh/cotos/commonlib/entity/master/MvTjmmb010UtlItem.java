...
public class MvTjmmb010UtlItem {
	 ...
	 */
	@Column(length = 256)
	@Schema(description = "マスタ名称", required = false, allowableValues = "range[0,256]")
	 ...
	 */
	@Column(length = 256)
	@Schema(description = "マスタ説明", required = false, allowableValues = "range[0,256]")
	 ...
	 */
	@Column(length = 4)
	@Schema(description = "マスタ主管区システムID", required = false, allowableValues = "range[0,4]")
	private String controlSystemId;

	/**
	 * コード値最大桁数
	 */
	@Schema(description = "コード値最大桁数", required = false)

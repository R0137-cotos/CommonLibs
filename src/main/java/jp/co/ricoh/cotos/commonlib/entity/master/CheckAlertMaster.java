...
public class CheckAlertMaster extends EntityBaseMaster {
	...
	@Schema(description = "チェックアラートマスタID", required = true, allowableValues = "range[0,9999999999999999999]")
	private long id;
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "チェックコード", required = true, allowableValues = "range[0,255]")
	 ...
	 */
	@Max(9)
	@Schema(description = "共通チェックフラグ", required = true, allowableValues = "range[0,255]")
	...
	@Schema(description = "チェックアラート対象マスタ", required = false)

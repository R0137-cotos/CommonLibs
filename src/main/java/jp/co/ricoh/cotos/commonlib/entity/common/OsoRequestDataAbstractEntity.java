...
public class OsoRequestDataAbstractEntity extends EntityBase {
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "申込書管理NO", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 * OSO管理番号採番状態
	 */
	@Schema(description = "OSO管理番号採番状態", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "未処理(\"0\"), 処理済(\"1\"), 処理対象外(\"9\"), 処理エラー(\"E\")", example = "0")
	private OsoManageNumberStatus osoManageNumberStatus;

	/**
	 * OSO管理番号登録日時
	 */
	@Schema(description = "OSO管理番号登録日時", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	@Temporal(TemporalType.TIMESTAMP)
	 ...
	 * データ区分
	 */
	@Schema(description = "データ区分", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "新規(\"1\"), 変更(\"2\")", example = "1")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "月額回収期間（開始）", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "月額回収期間（終了）", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "申込者：会社名", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "申込者：代表者名", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "申込者：住所", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "申込者：郵便番号", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "申込者：担当部課名", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "申込者：担当電話番号", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "申込者：担当FAX番号", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "申込者：担当者名", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "担当販売店：販売店名", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "担当販売店：営業所", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "担当販売店：契約管理NO", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "担当販売店：電話番号", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "担当販売店：FAX", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "担当販売店：担当者", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "担当販社：販売店名", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "担当販社：営業所", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "担当販社：仕入用管理NO", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "担当販社：電話番号", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "担当販社：FAX", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "担当販社：担当者", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "受付区：営業所名", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "受付区：課所コード", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "受付区：電話番号", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "受付区：FAX", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "受付区：担当者", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "担当区：営業所名", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "担当区：課所コード", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "担当区：電話番号", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "担当区：特記事項", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "COTOS商流区分", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")

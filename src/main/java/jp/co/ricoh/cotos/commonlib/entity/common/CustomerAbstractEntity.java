...
public class CustomerAbstractEntity extends EntityBase {
	...
	@Column(nullable = false)
	@Size(max = 255)
	@Schema(description = "MoM企事部ID(作成時不要)", allowableValues = "range[0,255]", readOnly = true)
	...
	@Column(nullable = false)
	@Size(max = 255)
	@Schema(description = "MoM企業ID(作成時不要)", allowableValues = "range[0,255]", readOnly = true)
	...
	@Column(nullable = false)
	@Size(max = 255)
	@Schema(description = "MoM事業所ID(作成時不要)", allowableValues = "range[0,255]", readOnly = true)
	 ...
	 */
	@Column(nullable = false)
	@Schema(description = "企事部設定区分(作成時不要)", allowableValues = "企事(\"1\"), 企事部(\"2\")", example = "1", readOnly = true)
	...
	@Column(nullable = false)
	@Size(max = 255)
	@Schema(description = "顧客名(作成時不要)", allowableValues = "range[0,255]", readOnly = true)
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "企業名(作成時不要)", allowableValues = "range[0,255]", readOnly = true)
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "企業名（カナ）(作成時不要)", allowableValues = "range[0,255]", readOnly = true)
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "事業所名(作成時不要)", allowableValues = "range[0,255]", readOnly = true)
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "部門名(作成時不要)", allowableValues = "range[0,255]", readOnly = true)
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "郵便番号(作成時不要)", allowableValues = "range[0,255]", readOnly = true)
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "住所(作成時不要)", allowableValues = "range[0,1000]", readOnly = true)
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "電話番号(作成時不要)", allowableValues = "range[0,255]", readOnly = true)
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "FAX番号(作成時不要)", allowableValues = "range[0,255]", readOnly = true)
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "企業代表者名(作成時不要)", allowableValues = "range[0,255]", readOnly = true)

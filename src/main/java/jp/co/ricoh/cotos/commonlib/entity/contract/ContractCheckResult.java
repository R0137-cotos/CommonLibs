...
public class ContractCheckResult extends EntityBase {
	...
	@Schema(description = "契約チェック結果ID(作成時不要)", required = true, allowableValues = "range[0,9223372036854775807]", readOnly = true)
	private long id;
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "チェック実施者MoM社員ID", required = false)

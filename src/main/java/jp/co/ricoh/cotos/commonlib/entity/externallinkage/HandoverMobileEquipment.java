...
public class HandoverMobileEquipment extends EntityBase {
	...
	@ApiModelProperty(value = "引継ぎ用モバイル機器ID(作成時不要)", required = true, position = 1, allowableValues = "range[0,9223372036854775807]", readOnly = true)
	private long id;
	 ...
	 */
	@Min(0)
	@ApiModelProperty(value = "引継ぎ元契約ID", required = false, position = 17, allowableValues = "range[0,9223372036854775807]")
	...
	@Max(9)
	@Min(0)
	@ApiModelProperty(value = "引継ぎ反映フラグ", required = false, position = 18, allowableValues = "range[0,9]")

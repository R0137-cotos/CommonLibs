...
public class ArrangementWorkOperationLog extends EntityBase {
	...
	public enum Operation {
		業務受付, 業務受付取消, 作業完了報告, 新規作成, 担当作業者設定, 更新, 作業完了, 業務完了取消, 保留更新, エラー発生, エラー解消, 業務指定作成, 帳票出力, 手配実施, 手配破棄, マネージド管理受付, ライセンス管理受付, CSV出力, CSV取込, 当日設定, クラウドアーカイブ管理受付, 事前設定, 詳細設定, ヤマト便同梱品確認書出力, ヤマト便お問合せ伝票番号設定
	}

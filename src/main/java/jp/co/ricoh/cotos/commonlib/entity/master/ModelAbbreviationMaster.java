...
public class ModelAbbreviationMaster extends EntityBaseMaster {
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "機種名(漢字)", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "機種名(カナ)", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "簡略機種名(カナ)", allowableValues = "range[0,255]")
	...
	@Max(99999)
	@Min(0)
	@Schema(description = "PM標準作業時間(分)", allowableValues = "range[0,99999]")
	...
	@Max(99999)
	@Min(0)
	@Schema(description = "点検標準作業(時間)", allowableValues = "range[0,99999]")
	 ...
	 */
	@DecimalMax("9999999999999999999.99")
	@Schema(description = "初年度保証費(年)", allowableValues = "range[0.00,9999999999999999999.99]")
	 ...
	 */
	@DecimalMax("9999999999999999999.99")
	@Schema(description = "初年度保証費(月)", allowableValues = "range[0.00,9999999999999999999.99]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "機種群名(漢字)", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "機種群名(カナ)", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "可能機番(始)", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "可能機番(終)", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "機種群名(カナ)1", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "機種群名(カナ)2", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "機種群名(カナ)3", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "機種群名(カナ)4", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "機種群名(カナ)5", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "機種群名(カナ)6", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "機種群名(カナ)7", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "機種群名(カナ)8", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "機種群名(カナ)9", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "機種群名(カナ)10", allowableValues = "range[0,255]")

...
public class ProductGrpIdentifierMaster extends EntityBaseMaster {
	...
	@Schema(description = "商品グループ識別子マスタID", required = true, allowableValues = "range[0,9999999999999999999]")
	private long id;
	...
	@Schema(description = "商品グループ識別子", required = true, allowableValues = "range[255]")
	 ...
	 */
	@Column(nullable = false)
	@Schema(description = "シーケンス名", required = true, allowableValues = "range[255]")

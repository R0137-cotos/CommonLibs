...
public class ConstructionEimApplyInfo extends EntityBase {
	 ...
	 * 注文種別
	 */
	@ApiModelProperty(value = "注文種別", required = false, position = 11, allowableValues = "転用(\"01\"), 転用+タイプ変更(\"02\"), タイプ変更(\"03\"), 新規(\"04\"), 移転(\"05\"), 同一フロア内移転(\"06\"), 終端装置変更(\"07\"), ひかり電話変更(\"08\"), 転入(\"09\"), 転出(\"10\"), NTT名義変更(\"11\"), 中断(\"12\"), 再開(\"13\"), ひかり電話追加(\"14\"), ひかり電話削除(\"15\"), 契約_オプション変更(\"16\"), 解約(\"17\"), 転入 + タイプ変更(\"18\"), メニュー変更(\"19\"), R割適用(\"20\")")

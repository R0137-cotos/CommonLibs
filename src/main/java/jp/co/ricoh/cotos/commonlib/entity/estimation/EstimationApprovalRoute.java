...
public class EstimationApprovalRoute extends EntityBase {
	...
	@Schema(description = "見積承認ルートID(作成時不要)", allowableValues = "range[0,9999999999999999999]", readOnly = true)
	private long id;
	...
	@Schema(description = "見積承認実績(作成時不要)", readOnly = true)
	...
	@Schema(description = "見積承認ルートノード(作成時不要)", readOnly = true)

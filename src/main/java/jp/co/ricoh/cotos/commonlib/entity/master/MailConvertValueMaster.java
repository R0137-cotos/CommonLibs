...
public class MailConvertValueMaster extends EntityBaseMaster {
	...
	@Schema(description = "通知メール変換値マスタID", required = true, allowableValues = "range[0,9999999999999999999]")
	private long id;
	 ...
	 * 件名/本文区分
	 */
	@Schema(description = "件名/本文区分", required = false, allowableValues = "件名(\"0\"), 本文(\"1\"), 本文(\"2\")", example = "1")
	 ...
	 */
	@Max(99)
	@Schema(description = "置換変数番号", required = false)
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "置換値エンティティ名", required = false, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "置換値フィールド名", required = false, allowableValues = "range[0,255]")
	 ...
	 */
	@Max(9)
	@Schema(description = "拡張項目フラグ", required = false, allowableValues = "range[0,9]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "置換値マスタ名", required = false, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "置換値マスタ検索エンティティ名", required = false, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "置換値マスタ検索フィールド名", required = false, allowableValues = "range[0,255]")
	private String replaceMasterSearchFieldName;

	/**
	 * 置換値区分
	 */
	@Schema(description = "置換値区分", required = false, allowableValues = "エンティティ(\"1\"), 独自SQL(\"2\")", example = "1")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "SQL区分", required = false, allowableValues = "range[0,255]")

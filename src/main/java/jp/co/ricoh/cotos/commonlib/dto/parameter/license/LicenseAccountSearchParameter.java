...
public class LicenseAccountSearchParameter {
	 ...
	 * 担当者メールアドレス
	 */
	@Parameter(description = "担当者メールアドレス")
	 ...
	 * MoM非連携_担当者電話番号
	 */
	@Parameter(description = "MoM非連携_担当者電話番号:前方一致")
	 ...
	 * 企業名（カナ）
	 */
	@Parameter(description = "企業名（カナ）:前方一致")
	 ...
	 * 企業名
	 */
	@Parameter(description = "企業名:前方一致")
	 ...
	 * MoM企事部ID
	 */
	@Parameter(description = "MoM企事部ID")
	 ...
	 * ライセンスアカウント区分名
	 */
	@Parameter(description = "ライセンスアカウント区分名")
	...
	@Max(9)
	@Min(0)
	@Parameter(description = "NSP検索追加フラグ")

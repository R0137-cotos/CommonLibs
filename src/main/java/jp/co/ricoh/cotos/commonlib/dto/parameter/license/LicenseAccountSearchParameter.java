...
public class LicenseAccountSearchParameter {
	...
	@ApiModelProperty(value = "MoM非連携_担当者電話番号:前方一致", required = false, position = 2, allowableValues = "range[0,255]")
	...
	@ApiModelProperty(value = "企業名（カナ）:前方一致", required = false, position = 3, allowableValues = "range[0,255]")
	...
	@ApiModelProperty(value = "企業名:前方一致", required = false, position = 4, allowableValues = "range[0,255]")
	...
	@ApiModelProperty(value = "契約番号", required = false, position = 6, allowableValues = "range[0,15]")
	...
	@ApiModelProperty(value = "ライセンスアカウント区分名", required = false, position = 9, allowableValues = "range[0,255]")

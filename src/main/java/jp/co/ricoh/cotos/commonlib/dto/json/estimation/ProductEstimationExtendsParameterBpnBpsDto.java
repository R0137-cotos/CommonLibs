...
public class ProductEstimationExtendsParameterBpnBpsDto {

	/**
	 * CPQ商品固有戻り値
	 */
	@JsonProperty("cpqProductSpecificReturnValue")
	private CpqReturnValueBpnBpsDto cpqReturnValueBpnBpsDto;

	/**
	 * COTOS商品固有項目
	 */
	@JsonProperty("cotosProductSpecificParameter")
	private CotosParameterBpnBpsDto cotosParameterBpnBpsDto;

...
public class ContractEquipmentDto extends DtoBase {
	 ...
	 * 本体フラグ
	 */
	@Schema(description = "本体フラグ", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "オプション(0),本体(1)")
	private Integer bodyFlg;

	/**
	 * サービス機器フラグ
	 */
	@Schema(description = "サービス機器フラグ", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "本体機器(0),サービス機器(1)")
	 ...
	 */
	@Size(max = 1000)
	@Schema(description = "メンテの注意(カナ)", allowableValues = "range[0,1000]")
	private String maintenanceNoteKana;

	/**
	 * Isys-One 処理状態
	 */
	@Schema(description = "Isys-One 処理状態", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "未処理(\"0\"),CSV作成済み(\"1\"),連携済み(\"2\"),連携エラー(\"3\")")
	 ...
	 */
	@Temporal(TemporalType.DATE)
	@Schema(description = "Isys-One 連携日時(1時間毎に連携するため日時とする)")
	 ...
	 * ARCS期間売保守処理状態
	 */
	@Schema(description = "ARCS期間売保守処理状態", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "未作成(\"0\"),作成済み(\"1\"),作成不要(\"2\"),作成エラー(\"3\")")

...
public class LicenseAccount extends EntityBase {
	 ...
	 */
	@Min(0)
	@ApiModelProperty(value = "ライセンス区分マスタID", required = false, position = 2, allowableValues = "range[0,9223372036854775807]")
	 ...
	 */
	@Min(0)
	@ApiModelProperty(value = "ライセンスアカウント区分マスタID", required = false, position = 3, allowableValues = "range[0,9223372036854775807]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "カスタマーID", required = false, position = 5, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "担当者メールアドレス", required = false, position = 11, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "企業名", required = false, position = 12, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "初期パスワード", required = false, position = 15, allowableValues = "range[0,255]")
	private String initialPassword;

	/**
	 * リクエスト作成状態
	 */
	@ApiModelProperty(value = "リクエスト作成状態", required = false, position = 16, allowableValues = "未作成(\"0\"), 作成済(\"1\"), 対象外(\"2\")")
	...
	@ApiModelProperty(value = "リクエスト作成日時", required = false, position = 17)
	...
	@ApiModelProperty(value = "ライセンス情報", required = false, position = 18)
	...
	@OneToMany(mappedBy = "licenseAccount")
	@OrderBy("seqNumber ASC")
	@ApiModelProperty(value = "ライセンスキー情報", required = false, position = 19)

...
public class ContractAssignmentAttachedFile extends EntityBase {
	...
	@Schema(description = "契約添付ファイルID", requiredMode = Schema.RequiredMode.REQUIRED, allowableValues = "range[0,9999999999999999999]")
	private long id;
	...
	@JsonIgnore
	@Schema(description = "契約業務ID", requiredMode = Schema.RequiredMode.REQUIRED)

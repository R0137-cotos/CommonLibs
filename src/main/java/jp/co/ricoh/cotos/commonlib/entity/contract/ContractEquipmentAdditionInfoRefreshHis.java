...
public class ContractEquipmentAdditionInfoRefreshHis extends EntityBase {
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "企業名(漢字)", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "事業所名(漢字)", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "企業名(カナ)", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "事業所名(カナ)", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "番地(漢字)", allowableValues = "range[0,255]")
	private String streetBunch;
	/**
	 * 号名(漢字)
	 */
	@Size(max = 255)
	@Schema(description = "号名(漢字)", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "ビル名(漢字)", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "設置部課名(漢字)", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "担当者名(漢字)", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "設置部課名(カナ)", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "担当者名(カナ)", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "保守担当課所コード(MoM組織ID)", allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "導入担当課所コード(MoM組織ID)", allowableValues = "range[0,255]")

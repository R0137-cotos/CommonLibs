...
public class OrderBasicInfo extends EntityBase {
	 ...
	 */
	@Column
	@Schema(description = "注文番号", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,]")
	 ...
	 */
	@Column
	@Schema(description = "注文タイプ", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "新規(\"1\"), 変更(\"2\"), 解約(\"3\"), キャンセル(\"4\")")
	 ...
	 */
	@Column
	@Schema(description = "商品種別", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "RSI(\"1\"), ROC(\"2\"), O365(\"3\"), MVB(\"4\")")
	 ...
	 */
	@Column
	@Schema(description = "契約番号", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,]")
	 ...
	 */
	@Column
	@Schema(description = "メーカー契約番号", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,]")
	 ...
	 */
	@Column
	@Schema(description = "商流区分（代直区分）", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "代売(\"1\"), 直売(\"2\")")
	...
	@Schema(description = "解約理由1", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	...
	@Schema(description = "解約理由2", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	 ...
	 */
	@Column
	@Schema(description = "改善ポイント", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	 ...
	 */
	@Column
	@Schema(description = "初期費合計", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	 ...
	 */
	@Column
	@Schema(description = "月額費合計", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	 ...
	 */
	@Column
	@Schema(description = "年額費合計", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	...
	@OneToOne(mappedBy = "orderBasicInfo")
	@Schema(description = "注文母店情報", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	...
	@OneToOne(mappedBy = "orderBasicInfo")
	@Schema(description = "注文管理情報", requiredMode = Schema.RequiredMode.NOT_REQUIRED)

...
public class ContractChecklistCompMaster extends EntityBaseMaster {
	...
	@Schema(description = "対象契約種別<br /> "//
			+ "共通/新規/契約変更/情報変更/契約更新", allowableValues = "共通(\"1\"), 新規(\"2\"), 契約変更(\"3\"), 情報変更(\"4\"), 契約更新(\"5\")", example = "1")
	...
	@Schema(description = "対象ライフサイクル状態<br /> "//
			+ "作成中/キャンセル手続き中/解約手続き中", allowableValues = "作成中(\"1\"), キャンセル手続き中(\"2\"), 解約手続き中(\"3\")", example = "1")

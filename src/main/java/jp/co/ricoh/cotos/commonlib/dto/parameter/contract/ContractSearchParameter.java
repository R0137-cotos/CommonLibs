...
public class ContractSearchParameter {
	 ...
	 * 商材固有項目 プロパティ名リスト
	 */
	@Parameter(description = "商材固有項目 プロパティ名リスト")
	 ...
	 * お客様：会社代表電話番号
	 */
	@Parameter(description = "お客様：会社代表電話番号")
	 ...
	 * 設置先：会社代表電話番号
	 */
	@Parameter(description = "設置先：会社代表電話番号")
	 ...
	 * モバイル：端末電話番号
	 */
	@Parameter(description = "モバイル：端末電話番号")
	 ...
	 * お客様：担当者電話番号
	 */
	@Parameter(description = "お客様：担当者電話番号")
	 ...
	 * 設置先：担当者電話番号
	 */
	@Parameter(description = "設置先：担当者電話番号")
	 ...
	 * ディスパッチ対応
	 */
	@Parameter(description = "ディスパッチ対応")
	 ...
	 * 承認周りの情報を除外
	 */
	@Parameter(description = "承認周りの情報を除外")

...
@Data
public class ContractExtChangeDto extends DtoBase {
	...
	@Size(max = 255)
	@NotNull
	@Schema(description = "web受注注文番号", required = true, allowableValues = "range[0,255]")
	 ...
	 * 締結希望日
	 */
	@Schema(description = "締結希望日", required = false)
	@Temporal(TemporalType.DATE)
	...
	@Valid
	@OneToMany(mappedBy = "contract")
	@Schema(description = "追加編集者", required = false)

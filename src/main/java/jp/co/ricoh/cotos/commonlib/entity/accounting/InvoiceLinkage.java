...
public class InvoiceLinkage extends EntityBase {
	...
	@Schema(description = "契約トランザクションID", required = true, allowableValues = "range[0,9999999999999999999]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "連携月", required = false, allowableValues = "range[0,255]")
	...
	@Schema(description = "契約単価　（月額商品の単価）", required = false, allowableValues = "range[0.00,99999999999999999.99]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "利用月", required = false, allowableValues = "range[0,255]")
	...
	@DecimalMin("0.00")
	@Digits(integer = 19, fraction = 2)
	@Schema(description = "単価", required = false, allowableValues = "range[0.00,99999999999999999.99]")
	private BigDecimal salesPrice;

	/**
	 * 税区分
	 */
	@Schema(description = "税区分", required = false, allowableValues = "range[0,255]")
	 ...
	 */
	@Max(99999)
	@Schema(description = "税率（％）", required = false, allowableValues = "range[0.00,99999999999999999.99]")
	...
	@DecimalMin("0.00")
	@Digits(integer = 19, fraction = 2)
	@Schema(description = "消費税", required = false, allowableValues = "range[0.00,99999999999999999.99]")
	...
	@DecimalMin("0.00")
	@Digits(integer = 19, fraction = 2)
	@Schema(description = "金額", required = false, allowableValues = "range[0.00,99999999999999999.99]")
	private BigDecimal remarks;

	/**
	 * 契約送信ステータス
	 */
	@Schema(description = "契約送信ステータス", required = false, allowableValues = "range[0,255]")
	private BatchCommonStatus sendStatus;

	/**
	 * 契約送信日
	 */
	@Schema(description = "契約送信日", required = false)
	 ...
	 * 請求受信ステータス
	 */
	@Schema(description = "請求受信ステータス", required = false, allowableValues = "range[0,255]")
	private BatchCommonStatus receiveStatus;

	/**
	 * 請求受信日
	 */
	@Schema(description = "請求受信日", required = false)
	@Temporal(TemporalType.DATE)
	 ...
	 * 計上ステータス
	 */
	@Schema(description = "計上ステータス", required = false, allowableValues = "range[0,255]")
	private BatchCommonStatus accountingStatus;

	/**
	 * 計上処理日
	 */
	@Schema(description = "計上処理日", required = false)
	@Temporal(TemporalType.DATE)

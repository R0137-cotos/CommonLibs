...
public class ArrangementSearchParameter {
	 ...
	 * 手配業務ステータス
	 */
	@Parameter(description = "手配業務ステータス:カンマ区切りで複数指定可", required = false)
	 ...
	 * 手配業務担当者
	 */
	@Parameter(description = "手配業務担当者：MoM社員IDを指定", required = false)
	 ...
	 * 業務受理日時(前)
	 */
	@Parameter(description = "業務受理日時(前)", required = false)
	 ...
	 * 業務受理日時(後)
	 */
	@Parameter(description = "業務受理日時(後)", required = false)
	@Schema(description = "業務受理日時<br />" //
			+ "日付フォーマット:yyyy/MM/dd HH", //
			required = false) //
	 ...
	 * お客様企業ID
	 */
	@Parameter(description = "企事部ID", required = false)
	 ...
	 * 手配承認日時(前)
	 */
	@Parameter(description = "手配承認日時(前)", required = false)
	 ...
	 * 手配承認日時(後)
	 */
	@Parameter(description = "手配承認日時(後)", required = false)
	@Schema(description = "手配承認日時<br />" //
			+ "日付フォーマット:yyyy/MM/dd HH", //
			required = false) //
	 ...
	 */
	@Parameter(description = "関連手配業務ステータス", required = false)

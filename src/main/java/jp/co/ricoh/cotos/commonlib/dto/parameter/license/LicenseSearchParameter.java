...
public class LicenseSearchParameter {
	 ...
	 * ライセンス検索区分
	 */
	@Parameter(description = "ライセンス検索区分")
	 ...
	 * ライセンス区分マスタID
	 */
	@Parameter(description = "ライセンス区分マスタID")
	 ...
	 * オーガニゼーションID
	 */
	@Parameter(description = "オーガニゼーションID")
	 ...
	 * サービス利用希望日（前）
	 */
	@Parameter(description = "サービス利用希望日（前）")
	 ...
	 * サービス利用希望日（後）
	 */
	@Parameter(description = "サービス利用希望日（後）")
	 ...
	 * Welcomeメール送信状況
	 */
	@Parameter(description = "Welcomeメール送信状況")
	 ...
	 */
	@Parameter(description = "MerakiスマートサービスオーガニゼーションID")
	 ...
	 * FFM発注問合せ番号
	 */
	@Parameter(description = "FFM発注問合せ番号")

...
public class LicenseSearchParameter {
	...
	@ApiModelProperty(value = "ライセンス", required = false, allowableValues = "range[0,255]")
	...
	@ApiModelProperty(value = "RJ管理番号", required = false, allowableValues = "range[0,255]")
	...
	@ApiModelProperty(value = "オーガニゼーションID", required = false, allowableValues = "range[0,255]")
	...
	@ApiModelProperty(value = "ライセンスキー", required = false, allowableValues = "range[0,255]")
	...
	@ApiModelProperty(value = "工程ステータス", required = false, allowableValues = "range[0,255]")
	...
	@ApiModelProperty(value = "キャンセル状態", required = false)
	...
	@ApiModelProperty(value = "受付状況フラグ", required = false)
	...
	@ApiModelProperty(value = "SS長作業完了承認日時", required = false)
	...
	@ApiModelProperty(value = "RMA契約番号", required = false, allowableValues = "range[0,255]")
	...
	@ApiModelProperty(value = "割当区分", required = false)

...
public class LicenseProcessResult {
	 ...
	 */
	@Id
	@Schema(description = "ライセンス工程ID(作成時不要)", allowableValues = "range[0,9223372036854775807]")
	private long id;
	 ...
	 */
	@Version
	@Schema(description = "ライセンス工程version(作成時不要)", allowableValues = "range[0,9223372036854775807]", readOnly = true)

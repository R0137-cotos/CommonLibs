...
public class LicenseAccountListInfo {
	 ...
	 * アカウント担当者メールアドレス
	 */
	@Schema(description = "アカウント担当者メールアドレス", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	private String accountPicMailAddress;

	/**
	 * アカウント企業名
	 */
	@Schema(description = "アカウント企業名", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	 ...
	 * インストールURL
	 */
	@Schema(description = "インストールURL", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,255]")
	private String installUrl;

	/**
	 * 費用種別
	 */
	@Schema(description = "費用種別", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "初期費(\"1\"), 月額_定額(\"2\"), 年額(\"3\"), 月額_従量(\"4\"), 違約金(\"5\")")

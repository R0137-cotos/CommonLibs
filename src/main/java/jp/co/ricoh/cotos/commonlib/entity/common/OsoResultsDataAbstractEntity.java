...
public class OsoResultsDataAbstractEntity extends EntityBase {
	...
	@Schema(description = "OSO申込明細ID", required = true, allowableValues = "range[0,9999999999999999999]")
	 ...
	 * 売上年月
	 */
	@Schema(description = "売上年月", required = false)
	 ...
	 * 手数料データ作成状態
	 */
	@Schema(description = "手数料データ作成状態", required = false, allowableValues = "未作成(\"0\"), 作成済(\"1\"), 作成対象外(\"9\"), 処理エラー(\"E\")", example = "0")
	 ...
	 * 納品日
	 */
	@Schema(description = "納品日", required = false)
	@Temporal(TemporalType.DATE)
	...
	@Schema(description = "リコー仕切単価", required = false, allowableValues = "range[0.00,99999999999999999.99]")
	...
	@DecimalMin("0.00")
	@Digits(integer = 19, fraction = 2)
	@Schema(description = "リコー売上単価", required = false, allowableValues = "range[0.00,99999999999999999.99]")
	 ...
	 * 納品場所識別
	 */
	@Schema(description = "納品場所識別", required = false, allowableValues = "届け先マスタの住所情報を利用(\"0\"), 納品場所を指定(\"1\")", example = "0")
	...
	@Size(max = 255)
	@Schema(description = "記事１（カナ）", required = false, allowableValues = "range[0,255]")
	...
	@Size(max = 255)
	@Schema(description = "記事２（カナ）", required = false, allowableValues = "range[0,255]")
	 ...
	 */
	@Digits(integer = 19, fraction = 2)
	@Schema(description = "販社仕入金額", required = false, allowableValues = "range[0.00,99999999999999999.99]")
	 ...
	 */
	@Digits(integer = 19, fraction = 2)
	@Schema(description = "接点店手数料金額", required = false, allowableValues = "range[0.00,99999999999999999.99]")
	 ...
	 * 費用種別
	 */
	@Schema(description = "費用種別", required = false, allowableValues = "初期費(\"1\"), 月額定額(\"2\"), 年額(\"3\"), 月額従量(\"4\")", example = "1")
	private CostType cotosCostType;

	/**
	 * 品種区分
	 */
	@Schema(description = "品種区分", required = false, allowableValues = "なし(\"0\"), 基本(\"1\"), オプション(\"2\")", example = "0")

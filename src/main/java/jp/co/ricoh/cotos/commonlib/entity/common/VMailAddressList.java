...
public class VMailAddressList {
	...
	public enum TableType {
		...
		担当SA("1"), 担当編集者("2"), 担当CE("3"), 販売店("4"), 顧客("5"), 担当作業者("6"), 導入CE("7"), 保守CE("8"), 大塚商会連絡用アドレス("101"), OR年額_大塚商会連絡用アドレス("102"), OR年額_OR営本グループアドレス("103"), EDW_年額更新時期案内_不着連絡用メールアドレス("104"), 脱RITOS更新案内_BBC宛先用メールアドレス("105"), O365事務局_BCC宛先用メールアドレス("106"), ISP手配区("107"), 担当作業者_担当CE("108"), SIM用固定メールアドレス("300"), 担当SA_追加編集者("1002"), 担当SA_導入担当CE_追加編集者("9"), 商品担当区グループアドレス("10"), 担当SA上長("1003"), 承認者_代理承認者("APPROVER"), 承認依頼者("APPROVAL_REQUESTER"), 担当SA_販売店("11"), 販売店_更新案内チェックあり("12"), 追加編集者_担当SA上長_導入担当CE_("13"), SSec不達連絡用メールアドレス("14");
	 ...
	 * テーブル区分
	 */
	@ApiModelProperty(value = "テーブル区分", required = true, position = 3, allowableValues = "担当SA(\"1\"), 担当編集者(\"2\"), 担当CE(\"3\"), 販売店(\"4\"), 顧客(\"5\"), 担当作業者(\"6\"), 導入CE(\"7\"), 保守CE(\"8\"), 大塚商会連絡用アドレス(\"101\"), OR年額_大塚商会連絡用アドレス(\"102\"), OR年額_OR営本グループアドレス(\"103\"), EDW_年額更新時期案内_不着連絡用メールアドレス(\"104\"),  脱RITOS更新案内_BBC宛先用メールアドレス(\"105\"), O365事務局_BCC宛先用メールアドレス(\"106\"), ISP手配区(\"107\"), 担当作業者_担当CE(\"108\"), 脱RITOS更新案内_BBC宛先用メールアドレス(\"105\"), SIM用固定メールアドレス(\"300\"), 担当SA_追加編集者(\"1002\"), 担当SA_導入担当CE_追加編集者(\"9\"), 商品担当区グループアドレス(\"10\"), 担当SA上長(\"1003\"), 承認者_代理承認者(\"APPROVER\"), SSec不達連絡用メールアドレス(\"14\")", example = "1")

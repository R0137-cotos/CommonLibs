...
public class ContractForFindAllDetailsDto extends EntityBase {
	 ...
	 */
	@Min(0)
	@Schema(description = "契約ID(作成時不要)", allowableValues = "range[0,9223372036854775807]", readOnly = true)
	private long id;
	 ...
	 */
	@Column(nullable = false)
	@Schema(description = "ライフサイクル状態(作成時不要)", allowableValues = "作成中(\"1\"), 作成完了(\"2\"), キャンセル手続き中(\"3\"), 破棄(\"4\"), 予定日待ち(\"5\"), 締結中(\"6\"), 解約手続き中(\"7\"), 解約予定日待ち(\"8\"), 解約(\"9\"), 旧契約(\"10\")", example = "1", readOnly = true)
	 ...
	 */
	@Column(nullable = false)
	@Schema(description = "ワークフロー状態(作成時不要)", allowableValues = "作成中(\"1\"), 承認依頼中(\"2\"), 承認済(\"3\"), 業務依頼中(\"4\"), 業務処理完了(\"5\"), キャンセル申請中(\"6\"), 売上可能(\"7\"), 解約申請中(\"8\")", example = "1", readOnly = true)
	private WorkflowStatus workflowStatus;

	/**
	 * 恒久契約識別番号
	 */
	@Schema(description = "恒久契約識別番号(作成時不要)", allowableValues = "range[0,255]", readOnly = true)
	 ...
	 */
	@Column(nullable = false)
	@Schema(description = "契約番号(作成時不要)", allowableValues = "range[0,255]", readOnly = true)
	 ...
	 */
	@Column(nullable = false)
	@Schema(description = "契約番号枝番(作成時不要)", allowableValues = "range[0,99]", readOnly = true)
	 ...
	 */
	@Column(nullable = false)
	@Schema(description = "売上計上フラグ(作成時不要)", allowableValues = "range[0,9]", readOnly = true)
	...
	@Schema(description = "契約チェック結果(作成時不要)", readOnly = true)
	 ...
	 */
	@OneToMany(mappedBy = "contract")
	@Schema(description = "契約承認ルート(作成時不要)", readOnly = true)
	 ...
	 */
	@OneToMany(mappedBy = "contract")
	@Schema(description = "契約添付ファイル(作成時不要)", readOnly = true)
	 ...
	 */
	@OneToMany(mappedBy = "contract")
	@Schema(description = "契約追加編集者社員(作成時不要)", readOnly = true)
	...
	@Schema(description = "契約操作履歴(作成時不要)", readOnly = true)
	...
	@Valid
	@OneToOne(mappedBy = "contract")
	@Schema(description = "契約保守担当CE社員(作成時不要)", readOnly = true)
	...
	@Valid
	@OneToOne(mappedBy = "contract")
	@Schema(description = "契約保守担当SS組織(作成時不要)", readOnly = true)
	...
	@Valid
	@OneToOne(mappedBy = "contract")
	@Schema(description = "契約受付担当SS組織(作成時不要)", readOnly = true)
	...
	@Valid
	@OneToOne(mappedBy = "contract")
	@Schema(description = "契約導入担当SS組織(作成時不要)", readOnly = true)
	 ...
	 */
	@OneToMany(mappedBy = "contract")
	@Schema(description = "契約添付ファイル履歴(作成時不要)")
	...
	@Valid
	@OneToOne(mappedBy = "contract")
	@Schema(description = "契約受付担当CE社員(作成時不要)", readOnly = true)
	...
	@Valid
	@OneToOne(mappedBy = "contract")
	@Schema(description = "契約導入担当CE社員(作成時不要)", readOnly = true)
	...
	@Valid
	@OneToMany(mappedBy = "contract")
	@Schema(description = "契約機種(作成時不要)", readOnly = true)

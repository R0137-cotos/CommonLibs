...
public class EnumType {
	...
	public enum ProcessCategory {
		...
		承認依頼("1"), 承認依頼取消("2"), 承認依頼差戻("3"), 承認("4"), 作業依頼("5"), 作業完了("6"), キャンセル手続き("7"), キャンセル手続き中止("8"), 解約手続き("9"), 解約手続き中止("10"), 問い合わせ("11"), 売上計上停止("12"), 売上計上再開("13"), 売上開始指示("14"), 問い合わせ返信("15"), 承認済差戻("16"), デバイス空欄警告("17"), 特殊審査依頼("18");
	...
	public enum PaymentCycleType {
		...
		private PaymentCycleType(final String text) {
			this.text = text;
		}

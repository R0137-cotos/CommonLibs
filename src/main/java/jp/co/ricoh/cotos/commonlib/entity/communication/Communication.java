...
public class Communication extends EntityBase {
	...
	@Schema(description = "依頼者 (作成時不要)<br />" //
			+ "ワークフローの起点となったユーザーのMoM社員IDを設定<br/>※POST時「RJ社員情報マスタ」存在チェック実施", required = true, allowableValues = "range[0,255]") //
	...
	@Schema(description = "伝達者<br />" //
			+ "ユーザー識別子としてMoM社員IDを設定<br/>※POST時「RJ社員情報マスタ」存在チェック実施", required = true, allowableValues = "range[0,255]") //
	...
	@Schema(description = "被伝達者候補<br />" //
			+ "ユーザー識別子としてMoM社員IDを設定<br/>※POST時「RJ社員情報マスタ」存在チェック実施", required = false, allowableValues = "range[0,255]") //

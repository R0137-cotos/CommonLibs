...
public class ContractEquipmentAdditionInfo extends EntityBase {
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "設置部課名(カナ)", required = false, position = 20, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "担当者名(カナ)", required = false, position = 21, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "顧客番号", required = false, position = 22, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "申請者社員ｺｰﾄﾞ", required = false, position = 23, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "保守担当課所コード(MoM組織ID)", required = false, position = 24, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "メンテ課所コード", required = false, position = 25, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "保守担当CEコード", required = false, position = 26, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "保守担当MoM社員ID", required = false, position = 27, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "保守部署名（漢字）", required = false, position = 28, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "保守担当者名（漢字）", required = false, position = 29, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "保守部署名（カナ）", required = false, position = 30, allowableValues = "range[0,255]")

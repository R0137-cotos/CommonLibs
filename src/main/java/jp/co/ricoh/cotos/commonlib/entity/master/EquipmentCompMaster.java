...
public class EquipmentCompMaster extends EntityBaseMaster {
	...
	@Schema(description = "機種構成マスタID", required = true, allowableValues = "range[0,9999999999999999999999999999]")
	private long id;
	...
	@Max(9)
	@Min(0)
	@Schema(description = "本体フラグ", required = false, allowableValues = "range[0,9]")
	...
	@Max(9)
	@Min(0)
	@Schema(description = "サービス機器フラグ", required = false, allowableValues = "range[0,9]")
	...
	@Max(9)
	@Min(0)
	@Schema(description = "保守売上連携フラグ", required = false, allowableValues = "range[0,9]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "振替対象品種マスタ", required = true, allowableValues = "range[0,255]")
	...
	@Max(9)
	@Min(0)
	@Schema(description = "機器品種作成フラグ", required = false, allowableValues = "range[0,9]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "メーカーコード", required = false, allowableValues = "range[0,255]")
	...
	@Max(9)
	@Min(0)
	@Schema(description = "機種削除可能フラグ", required = false, allowableValues = "range[0,9]")

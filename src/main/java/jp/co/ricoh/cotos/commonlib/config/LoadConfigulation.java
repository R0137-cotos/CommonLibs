package jp.co.ricoh.cotos.commonlib.config;
...
public class LoadConfigulation {
	...
	/**
	 * cotos.estimation.urlを取得
	 * @return cotos.estimation.url
	 */
	public static String getEstimationUrl() {

		String estimationUrl = "";
		try {
			LinkedHashMap<String, Object> cotos = (LinkedHashMap<String, Object>) configActive.get("cotos");
			LinkedHashMap<String, String> estimation = (LinkedHashMap<String, String>) cotos.get("estimation");
			estimationUrl = (String) estimation.get("url");
		} catch (Exception e) {
		}
		if (StringUtil.isEmpty(estimationUrl)) {
			LinkedHashMap<String, Object> cotos = (LinkedHashMap<String, Object>) configOrg.get("cotos");
			LinkedHashMap<String, String> estimation = (LinkedHashMap<String, String>) cotos.get("estimation");
			estimationUrl = (String) estimation.get("url");
		}

...
public class AttachedFileProductGrpCheckMaster extends EntityBaseMaster {
	...
	@Schema(description = "添付ファイル商品毎チェックマスタID", requiredMode = Schema.RequiredMode.REQUIRED, allowableValues = "range[0,9999999999999999999]")
	private long id;
	 ...
	 */
	@Min(0)
	@Schema(description = "品種マスタID", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,9999999999999999999]")
	 ...
	 */
	@Min(0)
	@Schema(description = "手配業務タイプマスタID", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "range[0,9999999999999999999]")
	 ...
	 * チェックタイミング区分
	 */
	@Schema(description = "チェックタイミング区分", requiredMode = Schema.RequiredMode.NOT_REQUIRED, allowableValues = "常時(\"0\"), 承認のみ(\"1\"), 常時しない(\"2\")")

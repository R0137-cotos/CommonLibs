...
public class TmCreateSubscriptionResponseWork extends AbstractTmResponseWork {
	...
	@Schema(description = "トレンドマイクロサブスクリプション作成レスポンスWORK ID", required = true, allowableValues = "range[0,9223372036854775807]", readOnly = true)
	private long id;
	...
	@JsonIgnore
	@Schema(description = "トレンドマイクロサブスクリプション作成リクエストWORK", required = true)

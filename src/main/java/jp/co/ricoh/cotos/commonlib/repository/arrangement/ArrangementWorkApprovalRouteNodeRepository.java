...
public interface ArrangementWorkApprovalRouteNodeRepository extends CrudRepository<ArrangementWorkApprovalRouteNode, Long> {
	public ArrangementWorkApprovalRouteNode findByArrangementWorkApprovalRouteIdAndApprovalOrderAndApproverEmpId(Long arrangementWorkApprovalRouteId, int approvalOrder, String approverEmpId);
}

...
public class ContractEquipment extends EntityBase {
	 ...
	 * Isys-One 処理状態
	 */
	@Schema(description = "Isys-One 処理状態", required = false, allowableValues = "未処理(\"0\"),CSV作成済み(\"1\"),連携済み(\"2\"),連携エラー(\"3\"),対象外(\"4\"),管理対象外(\"5\")")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "分類コード", required = false, allowableValues = "range[0,255]")
	private String classificationCode;

	/**
	 * 機器区分
	 */
	@Schema(description = "機器区分", required = false, allowableValues = "サーバー本体(\"1\"),HWオプション(\"2\"),SWオプション(\"3\")")

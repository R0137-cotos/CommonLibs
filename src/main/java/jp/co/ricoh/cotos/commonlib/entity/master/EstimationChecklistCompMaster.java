...
public class EstimationChecklistCompMaster extends EntityBaseMaster {
	...
	@Schema(description = "見積チェックリスト構成マスタID", requiredMode = Schema.RequiredMode.REQUIRED, allowableValues = "range[0,9999999999999999999]")
	private long id;
	...
	@Schema(description = "対象見積種別<br /> "//
			+ "共通/新規/契約変更<br /> ", allowableValues = "共通(\"1\"), 新規(\"2\"), 契約変更(\"3\")", example = "1")
	...
	@Schema(description = "対象ライフサイクル状態<br /> "//
			+ "作成中<br /> ", allowableValues = "作成中(\"1\")", example = "1")

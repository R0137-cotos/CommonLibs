...
public class ContractEquipmentNoIsysoneDto extends DtoBase {
	 ...
	 * 機器区分
	 */
	@Schema(description = "機器区分（Isys-Oneへの連携なし）", required = false, allowableValues = "ハードディスク(\"1\"), 内蔵オプション(\"2\"), 外付オプション(\"3\"), 導入ソフトウェア(\"4\")", example = "1")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "製品番号", required = false, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@Schema(description = "オプション名", required = false, allowableValues = "range[0,255]")

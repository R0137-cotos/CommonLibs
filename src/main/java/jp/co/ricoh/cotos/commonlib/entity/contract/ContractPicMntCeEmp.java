...
public class ContractPicMntCeEmp extends EmployeeAbstractEntity {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "contract_pic_mnt_ce_emp_seq")
	@SequenceGenerator(name = "contract_pic_mnt_ce_emp_seq", sequenceName = "contract_pic_mnt_ce_emp_seq", allocationSize = 1)

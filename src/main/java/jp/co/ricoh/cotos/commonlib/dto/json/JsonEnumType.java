...
public class JsonEnumType {
	...
	public enum ContractTypeDetails {
		...
		新規("1"), 契約更新("2"), 再契約("3"), アップグレード("4"), メニュー変更("5"), 基本プラン減数("6"), プラン_オプション_減数_削除("7"), オプション_追加_増数("8"), オプション_追加_減数("9"), 自動更新("10"), 転入("12"), ライセンス増数("13"), ライセンス減数("14"), オンサイトのみ("15"), メニュー追加変更("16"), オプション削除("17"), 発注ありオプション解約("18"), オプション積上げ("19"), 台数変更("20"), 更新期限の変更("21"), その他("99");

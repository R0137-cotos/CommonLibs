...
public class DateCalcPatternMaster extends EntityBaseMaster {
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "日付計算パターン名称", required = false, position = 5, allowableValues = "range[0,255]")
	...
	@NotNull
	@Column(nullable = false)
	@ApiModelProperty(value = "日付計算基準日区分", required = true, allowableValues = "サービス終了日(\"1\"), 契約開始日(\"2\"), システム日付(\"3\")", position = 7)
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "日付計算月数", required = false, position = 8, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "日付計算日数", required = false, position = 9, allowableValues = "range[0,255]")
	private String dateCalcDay;

	/**
	 * 日付計算営業日計算区分
	 */
	@ApiModelProperty(value = "日付計算営業日計算区分", required = true, allowableValues = "前営業日(\"1\"), 後営業日(\"2\")", position = 10)
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "日付計算設定時間", required = false, position = 11, allowableValues = "range[0,255]")
	 ...
	 */
	@Max(9)
	@ApiModelProperty(value = "日付計算営業日フラグ", required = false, position = 12, allowableValues = "range[0,255]")
	 ...
	 */
	@Size(max = 255)
	@ApiModelProperty(value = "日付計算汎用条件", required = false, position = 13, allowableValues = "range[0,255]")

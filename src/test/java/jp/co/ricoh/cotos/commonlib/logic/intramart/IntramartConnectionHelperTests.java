...
public class IntramartConnectionHelperTests {
	...
	public void 正常系_postIntraMartTest() {
		...
		registerInfo1.setKihyousha("起票者1");
		...
		registerInfo1.setIraiBusyoCode("課所コード1");
		...
		//		registerInfo2.setKihyousha("起票者2");
		...
		//		registerInfo2.setIraiBusyoCode("課所コード2");
	...
	/**
	 *  [POST] S&S作業依頼API 正常系_エラーテスト
	 */
	@Test
	public void 正常系_postIntraMartTestエラー() {
	...
	/**
	 *  [POST] S&S作業依頼API 異常系_エラーテスト
	 */
	@Test
	public void 異常系_postIntraMartTestエラー() {

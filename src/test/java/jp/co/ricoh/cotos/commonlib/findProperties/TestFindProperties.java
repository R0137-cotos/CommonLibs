...
public class TestFindProperties {
	...
	public void プロパティ取得() {
		...
		String username = isCi ? "cotos_ci_commonlibs_rsi" : "cotos_onsite_rsi";
		String password = isCi ? "cotos_ci_commonlibs_rsi" : "cotos_onsite_rsi";
		...
		Assert.assertEquals("DB設定：パスワードが正しく取得されること", password, appProperties.getDatasourceProperties().getPassword());
